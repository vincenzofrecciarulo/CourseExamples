...
public class BuildingType implements Serializable {
    ...
    @Column(name = "maintenace_cost", precision = 10, scale = 2)
    ...
    @Column(name = "production_rate", precision = 10, scale = 2)
    ...
    public String toString() {
        return "BuildingType{" +
                ...
                ", inputResource=" + (inputResource != null ? inputResource.getName() : "null") +
                ", outputResource=" + (outputResource != null ? outputResource.getName() : "null") +
                ", buildingsCount=" + (buildings != null ? buildings.size() : 0) +
                '}';
    }
}
