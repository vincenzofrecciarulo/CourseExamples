...
public enum House {
    ...
    public void initialize(int numStudents) {
        ...
        boolean hasExtra = numStudents%House.values().length != 0;      //controlla che numStudenti sia multiplo intero del numero di case così che ogni casa ha stesso numero di studenti
