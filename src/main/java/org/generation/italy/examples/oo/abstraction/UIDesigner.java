...
public class UIDesigner extends Person {
    ...
    public UIDesigner(String name, String surname, LocalDate dateofbirth, char gender, boolean hasExposed,
                      String... talents) {  // a varargs parameter is treated like an array
...
//        }
    ...
    public void startWorking() {
        System.out.println("Io non lavoro, io sono un artista! ");
    }
    ...
    public String toString() {
        ...
        sb.append("\n").append(hasExposed ? "Sono un artista famoso." : "Non ho ancora fatto successo...");
