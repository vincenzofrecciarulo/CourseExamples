...
public class LambdaLibrary {
    ...
    /*
    una lambda Consumer<String> usageCounter che conta le lettere di una String e
    aumenta un contatore statico privato all’interno di LambdaLibrary di quel numero
     */
    ...
    */
     ...
     */
    static Function<Integer,Integer> squared = (i) -> i * i;
