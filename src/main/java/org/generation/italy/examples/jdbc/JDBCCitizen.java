...
public class JDBCCitizen {
    ...
    private JDBCFaction faction;


    public JDBCCitizen() {
    }

    public JDBCCitizen(int id, String firstName, String lastName, char gender, int age, double salary, String educationLevel) {
        this.id = id;
    ...
    public JDBCCitizen(String firstName, String lastName, char gender, int age, double salary, String educationLevel) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.gender = gender;
        this.age = age;
    ...
    public JDBCCitizen(int id, String firstName, String lastName, char gender, int age,
    ...
    public void setFaction(JDBCFaction faction) {
